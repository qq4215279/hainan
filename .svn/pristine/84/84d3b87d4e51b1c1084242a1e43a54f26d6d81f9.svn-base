 ...
 */
(function () {
    var BSTable = function (bstableId, url, columns,leftFixedColumns,rightFixedColumns) {
        this.btInstance = null;					//jquery和BootStrapTable绑定的对象
        this.bstableId = bstableId;
        this.url = App.ctxPath + url;
        this.method = "post";
        ...
        this.leftFixedColumns= (leftFixedColumns==true);

        this.rightFixedColumns=( rightFixedColumns==true);
    };
    ...
    BSTable.prototype = {
        ...
        init: function () {
            ...
            this.btInstance =
                $('#' + tableId).bootstrapTable({
                    ...
                    iconSize: 'outline',
                    // leftFixedNumber:2,//固定列的默认配置
                    // rightFixedNumber:1,
                    // leftFixedColumns:this.leftFixedColumns,
                    // rightFixedColumns:this.rightFixedColumns,
         ...
         * 是否显示所有的列
         */
        setShowColumns: function (boolean) {
            this.showColumns = boolean;
        },
        ...
        selected: function () {
            return $('#' + this.bstableId).bootstrapTable('getSelections');
        }
