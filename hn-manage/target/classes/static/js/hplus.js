...
$(document).ready(function () {
    ...
    // MetsiMenu
    $('#side-menu').metisMenu().on('click', removeBadge);
    // 打开右侧边栏
...
//    });
    ...
    $('.navbar-minimalize').click(function (e) {
        ...
        /*console.log("aaaaa");*/
        $("body").toggleClass("mini-navbar");
        $(this).find("i").toggleClass("routate");
        $(this).toggleClass("li_nav");
        SmoothlyMenu();
    });
...
function removeBadge(e){
    if ($(e.target).context.tagName.toLowerCase() ==='a') {
        $(e.target).children('span.badge').remove();
    }else{
        $(e.target).parent('a').children('span.badge').remove();
    }
}
