...
var setting = { //展示左侧工会组织结构树
    ...
    async : {
        ...
        url : App.ctxPath + "/dept/belowTreeByOrgId",//对应的后台请求路径,//对应的后台请求路径
...
function addTreeNode(value) {
    ...
    var url = 'dept/organization/addOrganizationOrDept?id=' + zTree.getSelectedNodes()[0].id + '&deptType=' + value;
...
function editTreeNode() {
    ...
    var url = 'dept/organization/editOrganizationOrDept?id=' + zTree.getSelectedNodes()[0].id + '&deptType=' + value;
    var index = layer.open({
        type: 2,
        title: title,
        area: ['500px', height], //宽高
...
function removeTreeNode() {
    ...
    if (nodes && nodes.length > 0) {
        ...
        var operation = function () {
            var ajax = new $ax(App.ctxPath + "dept/organization/removeOrganizationAndDept", function () {
                App.success("删除成功!");
