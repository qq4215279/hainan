...
public class ZXingCode {
     ...
     * @return
     */
    public static File getLogoQRCode(InputStream logoFile, String content, String productName) {
        try {
     ...
     * @param logoPic
     */
    public File addLogo_QRCode(BufferedImage bim, InputStream logoPic, LogoConfig logoConfig, String productName) {
        try {
            /**
             * 读取二维码图片，并构建绘图对象
             */
...
//                  outg.drawString(productName, 0, image.getHeight() + (outImage.getHeight() - image.getHeight())/2 + 5 ); //画文字
            ...
            File qrFile = new File(UUIDUtil.getUUID()+".png");
